...
import mmp.lib.AppLibrary;
import mmp.lib.MMPLibrary;
...
public class ScheduleAppointmentHashMapTests {
	...
	public void bookAppointmentTests()
	{
		...
		mmpLib.selectDoctor("Pediatrician",expectedDoctor);
		...
		actualMap.put("date",driver.findElement(By.xpath("//table[@class='table']/tbody/tr[1]/td[1]")).getText());
		actualMap.put("time",driver.findElement(By.xpath("//table[@class='table']/tbody/tr[1]/td[2]")).getText());
		actualMap.put("sym",driver.findElement(By.xpath("//table[@class='table']/tbody/tr[1]/td[3]")).getText());
		actualMap.put("doctor",driver.findElement(By.xpath("//table[@class='table']/tbody/tr[1]/td[4]")).getText());
 
		Assert.assertTrue(actualMap.equals(expectedHMap));
